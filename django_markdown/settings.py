...
MARKDOWN_STORAGE = getattr(settings, 'MARKDOWN_STORAGE', None)
if MARKDOWN_STORAGE:
    MARKDOWN_STORAGE = get_storage_class(MARKDOWN_STORAGE)()
else:
    MARKDOWN_STORAGE = default_storage
MARKDOWN_UPLOAD_PATH = getattr(settings, 'MARKDOWN_UPLOAD_PATH', 'upload')
